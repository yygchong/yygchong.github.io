...
const tiktokExperience = `
    ...
    - Worked in a team of 3 to lead the deployments of payment infrastructure in the successful launch of the e-commerce TikTok Shop in the US, collaborating closely with international developers to debug issues, modify code, and ensure continuous uptime for one of TikTok's largest revenue streams.<br>
...
const sachacksProject = `<p> 
    ...
    - Led a team of 40+ people with the mission to create Sacramento's second annual intercollegiate Hackathon, an event aimed towards creating a lasting impact on young engineers, designers and entrepreneurs around the Sacramento region. <br>
...
const locknwalkProject = `<p> 
    <b> Co-Project Lead </b> <br> <i> 04.2019 - 01.2020 </i> <br> <br>
    - Developed an innovative skateboard rack that is more secure than current designs on the market. <br>
    - Won $1,000 in the Little Bang Startup competition to put towards prototyping. <br>
