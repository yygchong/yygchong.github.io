...
const workEmote1 = `<div id="workEmote1">Hey how's it going, happy holidays, <br> this is my <b style="font-size: 23px;">work experience</b>. <br> Just click the colorful dots to see more</div>`;
...
const aboutMeDefault = `<p> 
    ...
    - <b>Some of my hobbies include:</b> <br>
        - staying fit and exercising<br> 
        &ensp;&ensp; - volleyball <br>
        &ensp;&ensp; - pickleball <br>
        &ensp;&ensp; - kickboxing <br>
        &ensp;&ensp; - breakdancing *<i>(The middle video is <a href="https://www.teamusa.com/profiles/morris-isby">bboy morris</a> dunking on me)</i> <br>
        - reading <br>
